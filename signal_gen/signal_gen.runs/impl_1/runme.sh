...
HD_PWD='C:/Users/thara/Documents/signal_gen/signal_gen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Signal_gen_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Signal_gen_tb.tcl -notrace

...
HD_PWD='C:/Users/thara/Documents/Data_Encryption_STD/Data_Encryption_STD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DES_Main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DES_Main.tcl -notrace

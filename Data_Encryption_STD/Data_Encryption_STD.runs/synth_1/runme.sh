...
HD_PWD='C:/Users/thara/Documents/Data_Encryption_STD/Data_Encryption_STD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DES_Main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DES_Main.tcl

...
HD_PWD='C:/Users/thara/Documents/signal_gen/signal_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Signal_gen_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Signal_gen_tb.tcl
